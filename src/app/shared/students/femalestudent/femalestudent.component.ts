...
@Component({
  selector: 'app-femalestudent',
  templateUrl: './femalestudent.component.html',
  styleUrls: ['./femalestudent.component.css']
})
export class FemalestudentComponent implements OnInit {
  ...
  getAllFemaleStudents(){
    this.studentRegService.getAllFemaleStudents().subscribe(
      (data: Students[]) => {
